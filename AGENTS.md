# Barato.ar — Instrucciones para agentes

Contexto para cualquier agente (Claude, Codex, Cursor, etc.) que trabaje en este repo.
...
- Los agentes firman commits según su plataforma:
  - Claude Code: `Co-Authored-By: Claude Opus 4.7 <noreply@anthropic.com>`
  - Otros agentes: usar su footer estándar
...
pnpm build                        # SKIP_ENV_VALIDATION=1 pnpm build
